...
define('socket.io-client',['require','exports','module'],function (require, exports, module) {
...
define('viewmodels/chat_view',['require','exports','module','jquery','socket.io-client'],function (require, exports, module) {
!function() {
  ...
  function ChatView( options ) {
    ...
    this.$authorDisplay = this.$el.find( '.author' )
    this.$authorDisplay.text( this.senderName )
    ...
    this.socket.on( 'accept:name:change', function( name ) {
      ...
      self.$authorDisplay.text( self.senderName )
    })
...
define('viewmodels/name_picker',['require','exports','module','jquery','eventemitter2'],function (require, exports, module) {
!function() {
